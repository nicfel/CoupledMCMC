...
"This is almost the same object as in the beast core, but allows to copy PrintStream between heated chains")
public class Logger extends BEASTObject {
    ...
    /**
     * if false, the logger is not actually used.
     */
    boolean isLogging = true;
    
    /**
     * if loggin is to the screen
     */
    boolean isScreenLog = false;
